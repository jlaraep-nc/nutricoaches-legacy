(function($){
			...
			frame: function () {
				...
				this._frame.on('update', function () {
					...
					jQuery.ajax({
						type: "post",
						url: ajaxurl,
						data: "action=powerlift_mikado_gallery_upload_get_images&ids=" + ids,
	...
	function mkdfInitAjaxForm() {
		...
		$(document).delegate(".mkdf_ajax_form", "submit", function (a) {
			var b = $(this),
				c = {
					action: "powerlift_mikado_save_options"
				};
		...
		if (holder.length) {
			...
			mkdfImportBtn.on('click', function (e) {
				...
				if (confirm('Are you sure, you want to import Options now?')) {
					...
					var data = {
						action: 'powerlift_core_import_theme_options',
						content: importValue,
						nonce: importNonce
					};
		...
		if (holder.length) {
			...
			mkdfImportBtn.on('click', function (e) {
				...
				if (confirm('Are you sure, you want to import Custom Sidebars now?')) {
					...
					var data = {
						action: 'powerlift_core_import_custom_sidebars',
						content: importValue,
						nonce: importNonce
					};
		...
		if (holder.length) {
			...
			mkdfImportBtn.on('click', function (e) {
				...
				if (confirm('Are you sure, you want to import Widgets now?')) {
					...
					var data = {
						action: 'powerlift_core_import_widgets',
						content: importValue,
						nonce: importNonce
					};
